...
/*
  ...
  back to that placeholder for everyone. This joins each ad to its
  actual owner's registered fullName and a real completed-order count
  computed from p2pOrders, so the name shown always matches whoever
  actually posted the ad.
*/
function sellerPublicInfo(sellerId) {
  ...
  const fullName = (user && user.fullName) || 'Unverified User';
